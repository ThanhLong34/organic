<template>
  <div class="shop-details">
    <TopPage :currentPage="'Shop Details'" />
          ...
          <div class="row">
            ...
            <div class="col l-6 m-12 s-12">
              ...
              <div class="shop-details-product-info">
                <h4 class="shop-details-product-name">Veggan Egg Fresh</h4>
                ...
                <p class="shop-details-product-price">
                  <span class="shop-details-product-price-old">$200.00</span>
                  <span class="shop-details-product-price-new"
                    >$180.00
                    <span class="shop-details-product-unit">/ Kg</span></span
                  >
                </p>
                <p class="shop-details-product-desc">
                  ...
                  bed. The goodness of rolled wholegrain oats are combined.
                </p>
                <div class="shop-details-product-ctrl">
                  ...
                  <div class="shop-details-product-ctrl-other">
                    <button-v-2 class="shop-details-product-ctrl-addtocart-btn">
                      Add to cart
