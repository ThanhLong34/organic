          ...
          <div class="col l-9 m-8 s-12">
            <div class="blog-details-main">
              ...
              <div class="blog-details-body">
                <p>
                  Morbi mollis vestibulum sollicitudin. Nunc in eros a justo
                  facilisis rutrum. Aenean id ullamcorper libero. Vestibulum
                  imperdiet nibh vel magna lacinia ultrices. Sed id interdum
                  urna.
                </p>
                <img src="@/assets/images/blog_details/exp1.jpg" alt="image" />
                <p>
                  Nam ac elit a ante commodo tristique. Duis lacus urna,
                  condimentum a vehicula a, hendrerit ac nisi Lorem ipsum dolor
                  sit amet, consectetur adipiscing elit. Aliquam vulputate,
                  tortor nec commodo ultricies, vitae viverra urna nulla sed
                  turpis. Nullam lacinia faucibus risus, a euismod lorem
                  tincidunt id.
                </p>
              ...
              <div class="row">
                ...
                <div class="col l-12 m-12 s-12">
                  <div>
                    ...
                    >
                      <swiper-slide v-for="(item, index) in blogs" :key="index">
                        <BlogV1 :blog="item" />
                      </swiper-slide>
                    </swiper>
                  </div>
