<template>
  <div class="home">
    <!-- top -->
    <section class="top-section" @mousemove="handleMoveEffectTopImage">
      <div class="grid wide">
        <div class="row">
          <div class="col l-6 m-8 s-12">
            <div class="top-section-txt">
              <p class="top-section-title">100% Organic Foods</p>
              <h1 class="top-section-heading">
                Organic Veggies Coock
                <span>Healthy</span>
              </h1>
              <p class="top-section-para">
          ...
          <div class="col l-6 m-0 s-0">
            <div class="top-section-img">
              <img
                src="@/assets/images/home/img_top.png"
                alt="image"
                ref="homeTopImageNode"
              />
            </div>
          </div>
        </div>
    ...
    <div class="bg-wrapper">
        ...
        <div class="grid wide">
          <div class="row">
            <div class="col l-3 m-6 s-12">
              <div class="icon-section-item">
                <div class="icon-section-item-img">
                  <svg
                    version="1.0"
                ...
                <div class="icon-section-item-btn-wrap">
                  <button-v-1>READ MORE</button-v-1>
                </div>
              </div>
            </div>
            <div class="col l-3 m-6 s-12">
              <div class="icon-section-item">
                <div class="icon-section-item-img">
                  ...
                  <img src="@/assets/images/home/icon_2.png" alt="icon" />
                </div>
                <h5 class="icon-section-item-heading">
            ...
            <div class="col l-3 m-6 s-12">
              <div class="icon-section-item">
                <div class="icon-section-item-img">
                  ...
                  <img src="@/assets/images/home/icon_3.png" alt="icon" />
                </div>
                <h5 class="icon-section-item-heading">
            ...
            <div class="col l-3 m-6 s-12">
              <div class="icon-section-item">
                <div class="icon-section-item-img">
                  ...
                  <img src="@/assets/images/home/icon_4.png" alt="icon" />
                </div>
                <h5 class="icon-section-item-heading">
                  100% <span>Natural Product</span>
                </h5>
                <p class="icon-section-item-desc">
                  Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed
                  diam.
          ...
          <div class="row">
            <div class="col l-7 m-12 s-12">
              <div class="about-section-img">
                <img src="@/assets/images/home/about_bg.png" alt="image" />
              </div>
            </div>
            <div class="col l-5 m-12 s-12">
              <div class="about-section-txt">
                <p class="about-section-top">START FROM <span>$39.99</span></p>
      ...
      <section class="offer-section">
        <div class="grid wide">
          <div class="row offer-section-wrap">
            <div class="col l-6 m-9 s-12">
              <div class="offer-section-txt">
                <h5 class="offer-section-heading">
                  Blueberry <span>&amp;</span> Seeds
                </h5>
                <p class="offer-section-price">$280.00</p>
                <p class="offer-section-para">
                  Apparently we had reached a great height in the atmosphere,
                  for the sky was a dead black, and the.
                </p>
                <div class="offer-section-timeout">
                  <div class="offer-section-timeout-title">GRAB THE OFFER</div>
                  <ul class="offer-section-timeout-list">
                    <li class="offer-section-timeout-item">
                      <div class="offer-section-timeout-item-time">
                        {{ secondsToDhms(saleTime).d }}
                      </div>
                      <div class="offer-section-timeout-item-label">days</div>
                    </li>
                    <li class="offer-section-timeout-item">
                      <div class="offer-section-timeout-item-time">
                        {{ secondsToDhms(saleTime).h }}
                      </div>
                      <div class="offer-section-timeout-item-label">hours</div>
                    </li>
                    <li class="offer-section-timeout-item">
                      <div class="offer-section-timeout-item-time">
                        {{ secondsToDhms(saleTime).m }}
                      </div>
                      <div class="offer-section-timeout-item-label">
                        minutes
                      </div>
                    </li>
                    <li class="offer-section-timeout-item">
                      <div class="offer-section-timeout-item-time">
                        {{ secondsToDhms(saleTime).s }}
                      </div>
                      <div class="offer-section-timeout-item-label">
                        seconds
                      </div>
        ...
        <div class="grid wide">
          <div class="row">
            <div class="col l-12 m-12 s-12">
              <heading-section>
                <template #strong>Nutrition </template>
                <template #default>Organic Product</template>
              </heading-section>
            </div>
            <div class="col l-5 m-12 s-12">
              <div class="nutrition-section-item">
                <img src="@/assets/images/home/nutrition_1.jpg" alt="image" />
                <p class="nutrition-section-item-1">
                  <strong>Nutrition</strong> Organic
                </p>
              </div>
            </div>
            <div class="col l-7 m-12 s-12">
              <div class="nutrition-section-item">
                <img src="@/assets/images/home/nutrition_2.jpg" alt="image" />
                <p class="nutrition-section-item-2">
                  <strong>Super</strong> Protein
                </p>
              </div>
            </div>
          </div>
      ...
      <section class="slider-section">
        <div class="grid wide">
          ...
          >
            <swiper-slide>
              <div class="slider-section-product">
                <div class="row">
                  <div class="col- l-5 m-5 s-12">
                    <div class="slider-section-product-txt">
                      <div class="slider-section-product-price">$280.00</div>
                      <h5 class="slider-section-product-name">
                        <strong>Avocado</strong> Organic
                      </h5>
                      <p class="slider-section-product-desc">
                        Broccoli Roses, Alway Fresh And Delicious
                        <br />
                        100% Organic
                      </p>
                      <button-v-2>
                  ...
                  <div class="col- l-7 m-7 s-12">
                    <div class="slider-section-product-img">
                      <img
                        src="@/assets/images/home/slider_1.png"
                        alt="product image"
                      />
                    </div>
                  </div>
              ...
              <div class="slider-section-product">
                <div class="row">
                  ...
                  <div class="col- l-7 m-7 s-12">
                    <div class="slider-section-product-img">
                      <img
                        src="@/assets/images/home/slider_3.png"
                        alt="product image"
                      />
                    </div>
                  </div>
              ...
              <div class="slider-section-product">
                <div class="row">
                  ...
                  <div class="col- l-7 m-7 s-12">
                    <div class="slider-section-product-img">
                      <img
                        src="@/assets/images/home/slider_4.png"
                        alt="product image"
                      />
                    </div>
                  </div>
      ...
      <section class="product-section">
        <div class="grid wide">
          <div class="row">
            <div class="col l-12 m-12 s-12">
              <heading-section>
                <template #strong>New </template>
                <template #default>Arrivals Goods</template>
              </heading-section>
            </div>
            <div
          ...
          <div class="row">
            ...
            <div class="col l-6 m-12 s-12">
              <div class="blog-section-txt">
                <heading-section>
                  <template #strong>Naturix </template>
                  <template #default> Organic Goods </template>
                </heading-section>
                <p class="blog-section-para">
                  Apparently we had reached a great height in the atmosphere,
                  for the sky was a dead black, and the stars had ceased to
                  twinkle. Apparently we had reached a great height in the
...
export default {
  ...
  setup() {
    ...
    const saleTime = computed(() => {
      return store.getters.getSaleTime;
    });
...
.top-section {
  ...
  &-title {
    ...
    color: #313131;
    display: block;
    background: url("@/assets/images/home/title_bg.png") no-repeat center
      center/cover;
    margin-bottom: 25px;
    position: relative;
    animation: showHomeTopTitle ease-out 2s forwards;
  }
  ...
  &-heading {
    ...
    margin-bottom: 25px;
    position: relative;
    animation: showHomeTopHeading ease-out 2s forwards;
  ...
  &-para {
    ...
    margin-bottom: 25px;
    position: relative;
    animation: showHomeTopPara ease-out 3s forwards;
  }

  &-btn-wrap {
    position: relative;
    animation: showHomeTopBtn ease-out 3.5s forwards;
  ...
  &-img {
    animation: showHomeTopImg ease 3s forwards;
  }
...
.icon-section {
  padding-top: 100px;
  position: relative;
  background: url("@/assets/images/home/icon_bg.png") no-repeat center;
...
.offer-section {
  ...
  &-wrap {
    position: relative;
    background: url("@/assets/images/home/offer_bg.png") no-repeat center
      center/cover #fff;
    border-radius: 24px;
    margin-left: 0;
    margin-right: 0;
...
.nutrition-section {
  ...
  &-item {
    ...
    .nutrition-section-item-1 {
      bottom: 112px;
      right: -158px;
    }

    .nutrition-section-item-2 {
      bottom: 80px;
      right: -125px;
    }
  }
...
.slider-section {
  ...
  background: url("@/assets/images/home/slider_bg.png") no-repeat center center;
  user-select: none;
...
.product-section {
  padding: 100px 0;
  background: url("@/assets/images/home/product_bg.png") no-repeat center;
...
.blog-section {
  ...
  background: url("@/assets/images/home/blog_bg.png") no-repeat center/cover;
