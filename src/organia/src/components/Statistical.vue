        ...
        <div class="col l-3 m-6 s-12">
          <div class="statistical-item">
            <div class="statistical-item-icon">
              <img src="@/assets/images/statistical/person.svg" alt="icon" />
            </div>
            <div class="statistical-item-txt">
              <p class="statistical-item-quantity" data-value="1005">0</p>
              <p class="statistical-item-label">Satisfied Clients</p>
            </div>
          </div>
        </div>
        <div class="col l-3 m-6 s-12">
          <div class="statistical-item">
            <div class="statistical-item-icon">
              <img src="@/assets/images/statistical/team.svg" alt="icon" />
            </div>
            <div class="statistical-item-txt">
              <p class="statistical-item-quantity" data-value="224">0</p>
              <p class="statistical-item-label">Expert Team</p>
            </div>
          </div>
        </div>
        <div class="col l-3 m-6 s-12">
          <div class="statistical-item">
            <div class="statistical-item-icon">
              <img src="@/assets/images/statistical/product.svg" alt="icon" />
            </div>
            <div class="statistical-item-txt">
              <p class="statistical-item-quantity" data-value="596">0</p>
              <p class="statistical-item-label">Activate Products</p>
            </div>
          </div>
        </div>
        <div class="col l-3 m-6 s-12">
          <div class="statistical-item">
            <div class="statistical-item-icon">
              <img src="@/assets/images/statistical/award.svg" alt="icon" />
            </div>
            <div class="statistical-item-txt">
              <p class="statistical-item-quantity" data-value="98">0</p>
              <p class="statistical-item-label">Awards Winning</p>
            </div>
          </div>
        </div>
      </div>
