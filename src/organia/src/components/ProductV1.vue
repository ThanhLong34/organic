<template>
  <div class="product-v1">
    <div class="product-v1-img">
      <img :src="`${require(`@/assets/images/product/${product.image}`)}`" alt="product image" />
    </div>
    <div class="product-v1-info">
      ...
      <div class="product-v1-ctrl">
        <div class="product-v1-ctrl-quantity">
          <button class="product-v1-ctrl-sub-btn" @click="handleSubQuantity">
            &minus;
          </button>
          <span>{{ info.quantity }}</span>
          <button class="product-v1-ctrl-add-btn" @click="handleAddQuantity">
            &plus;
          </button>
        </div>
