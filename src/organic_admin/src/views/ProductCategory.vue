                              ...
                              <tr v-for="item in tableData" :key="item.id">
                                 ...
                                 <td class="align-middle">
                                    <div class="ms-auto text-end action-btns">
													<a
														v-if="checkPermissionFunction(functions.UpdateProductCategory)"
                                       ...
                                       <el-popconfirm
                                          v-if="
                                             checkPermissionFunction(
                                                functions.TrashProductCategory
                                             )
                                          "
...
import AddProductCategoryDialog from "./components/dialogs/AddProductCategoryDialog.vue";
import EditProductCategoryDialog from "./components/dialogs/EditProductCategoryDialog.vue";
