         ...
         <div class="col-12">
                  ...
                  <div class="card-header pb-0">
                     <div class="row">
                        <div class="col-6 d-flex align-items-center">
                           <h6>Danh sách trạng thái đơn hàng ({{ tableData.length }})</h6>
                        </div>
                        <div class="col-6 text-end" v-if="checkPermissionFunction(functions.AddOrderStatus)">
                           <argon-button
                              color="info"
                              variant="gradient"
                              ...
                              <tr v-for="item in tableData" :key="item.id">
                                 ...
                                 <td class="align-middle">
                                    <div class="ms-auto text-end action-btns">
                                       <a
														v-if="checkPermissionFunction(functions.UpdateOrderStatus)"
                                       ...
                                       <el-popconfirm
														v-if="checkPermissionFunction(functions.TrashOrderStatus)"
            ...
            <div v-if="addDialog.visible">
               <el-dialog v-model="addDialog.visible">
                  <AddOrderStatusDialog @onCloseDialog="handleCloseDialog" />
               </el-dialog>
            </div>
            <!-- Edit dialog -->
...
import AddOrderStatusDialog from "./components/dialogs/AddOrderStatusDialog.vue";
import EditOrderStatusDialog from "./components/dialogs/EditOrderStatusDialog.vue";
