                  ...
                  <div class="card-header pb-0">
                     <div class="row">
                        <div class="col-6 d-flex align-items-center">
                           <h6>Danh sách KH liên hệ ({{ tableData.length }})</h6>
                        </div>
                     </div>
                  </div>
                  <!-- Table -->
                              ...
                              <tr v-for="item in tableData" :key="item.id">
                                 <td>
                                    ...
                                    <span
                                       ...
                                       :class="item.status == 1 ? 'bg-gradient-success' : 'bg-gradient-secondary'"
                                    >
                                       {{
                                 ...
                                 <td class="align-middle">
                                    <div class="ms-auto text-end action-btns">
													<a
														v-if="checkPermissionFunction(functions.ViewContactDetails)"
...
import ViewContactDetailsDialog from "./components/dialogs/ViewContactDetailsDialog.vue";
