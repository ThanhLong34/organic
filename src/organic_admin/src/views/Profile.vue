   ...
   <main>
      <div class="container-fluid">
         <div
            ...
            :style="{
               backgroundImage: `url('${require('@/assets/img/du_lich_da_lat.jpg')}')`,
                        ...
                        >
                           <li class="nav-item">
                              ...
                              >
                                 ...
                                 <span class="ms-1">Ứng dụng</span>
                              </a>
                           </li>
                           <li class="nav-item">
                              <a
                                 class="px-0 py-1 mb-0 nav-link my-tab-profile"
                                 data-bs-toggle="tab"
                                 href="javascript:;"
                                 role="tab"
                                 aria-selected="false"
      ...
      <div class="py-4 container-fluid">
         <div class="row">
            <div class="col-md-8">
               <!-- Profile -->
               <div class="card" v-show="!isShowChangePassword">
                  <div class="card-header pb-0">
                     <div class="d-flex align-items-center">
                        <p class="mb-0">Hồ sơ Admin</p>
                        <argon-button
                           color="success"
                           variant="gradient"
                           size="sm"
                           ...
                           >Thay đổi mật khẩu</argon-button
                        >
                     </div>
                  </div>
                  <div class="card-body">
