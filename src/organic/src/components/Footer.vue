         ...
         <div class="row">
               ...
               <div class="footer-left">
                  <address class="address">
                     ...
                     <div class="address-item">
                        ...
                        <div class="address-item-txt">
                           <p class="address-item-label">Địa chỉ</p>
                           <p class="address-item-value">
                              TP Đà Lạt - Lâm Đồng
                           </p>
                        </div>
            ...
            <div class="col l-4 m-6 s-12">
               <div class="footer-mid">
                  ...
                  <p class="footer-mid-para">
                     Cảm ơn bạn đã ghé qua cửa hàng của chúng tôi.
                  </p>
                  <div class="footer-mid-social-list">
                     <a
                        class="footer-mid-social-item"
                        target="_blank"
            ...
            <div class="col l-4 m-12 s-12">
               <div class="footer-right">
                  <p class="footer-right-title">DỊCH VỤ KHÁCH HÀNG</p>
                  <nav class="service">
                     ...
                     <div class="service-link">
                        <router-link :to="{ name: 'tracking_order' }">
                           <i class="fa-solid fa-caret-right"></i>
                           Tra cứu đơn hàng
                        </router-link>
                     </div>
                     ...
                     <div class="service-link">
                        <router-link :to="{ name: 'help_and_faq' }">
                           <i class="fa-solid fa-caret-right"></i>
                           Giúp đỡ &amp; Hỏi đáp
                        </router-link>
                     </div>
